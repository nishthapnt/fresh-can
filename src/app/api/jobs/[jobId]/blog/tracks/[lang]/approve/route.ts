...
export async function POST(
  ...
  const hero = asRecord(draftImages.hero)
  const inline = asRecord(draftImages.inline)
  ...
  const htmlFinal = typeof d.html_final === 'string' && d.html_final ? d.html_final : reconstructHtml(d)

...
// (no migration needed). worker/src/index.ts's tickPipelines/tickTracks
// queries already exclude 'failed' pipelines/tracks entirely, so this is a
// genuine, immediate stop.
